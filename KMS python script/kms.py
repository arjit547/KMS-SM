...
# Function to get IAM user name from principalId
...
# Function to extract IAM username from CloudTrail events
...
# Function to extract the last access time from CloudTrail events
...
kms_csv_file_path = 'kms_details_all_regions.csv'
...
with open(kms_csv_file_path, mode='w', newline='') as kms_csv_file:
    ...
    iam_client = boto3.client('iam')  # Added IAM client here
...
print(f"KMS CSV file generated: {kms_csv_file_path}")
